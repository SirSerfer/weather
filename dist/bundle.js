...
/******/ 	var hotCurrentHash = "abfbe471d8418f014a34"; // eslint-disable-line no-unused-vars
...
var string = __webpack_require__(136);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dark_sky_api__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dark_sky_api___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_dark_sky_api__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_chart_js__ = __webpack_require__(131);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_chart_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_chart_js__);



__WEBPACK_IMPORTED_MODULE_0_dark_sky_api___default.a.apiKey = '21e22ddd92fa2e53acb69b4a9391cedc';
__WEBPACK_IMPORTED_MODULE_0_dark_sky_api___default.a.units = 'si'; // default 'us'
__WEBPACK_IMPORTED_MODULE_0_dark_sky_api___default.a.language = 'ru';


__WEBPACK_IMPORTED_MODULE_0_dark_sky_api___default.a.loadCurrent()
  .then(result => {
...
__WEBPACK_IMPORTED_MODULE_0_dark_sky_api___default.a.loadForecast()
  .then(result => {
    for(let i = 0; i < 4; i++) {
...
__WEBPACK_IMPORTED_MODULE_0_dark_sky_api___default.a.loadPosition()
  .then(pos => {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dark_sky_skeleton__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dark_sky_skeleton___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_dark_sky_skeleton__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_moment__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_geo_loc_utils__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_geo_loc_utils___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_geo_loc_utils__);
...
class DarkSkyApi {
  ...
  constructor(apiKey, proxyUrl, units, language, processor) {
    this.darkSkyApi = new __WEBPACK_IMPORTED_MODULE_0_dark_sky_skeleton___default.a(apiKey, proxyUrl);
  ...
  loadForecast() {
    ...
    return this.darkSkyApi.units(this._units).language(this._language).exclude(config.excludes.filter(val => val != 'daily').join(',')).extendHourly(this._extendHourly).time(false).get().then(data => {
      ...
      !data.daily ? null : data.daily.updatedDateTime = __WEBPACK_IMPORTED_MODULE_1_moment___default.a();
      return data;
    });
  }
  ...
  loadItAll(excludesBlock) {
    ...
    return this.darkSkyApi.units(this._units).language(this._language).exclude(excludesBlock).extendHourly(this._extendHourly).time(false).get().then(data => {
      ...
      data.updatedDateTime = __WEBPACK_IMPORTED_MODULE_1_moment___default.a();
      return data;
    });
  }
  ...
  loadTime(time) {
    ...
    time = __WEBPACK_IMPORTED_MODULE_1_moment___default.a.isMoment(time) ? time.format(config.dateFormat) : time;
  ...
  processWeatherItem(item) {
    item.windDirection = __WEBPACK_IMPORTED_MODULE_2_geo_loc_utils__["degreeToCardinal"](item.windBearing);
    !item.nearestStormBearing ? null : item.nearestStormDirection = __WEBPACK_IMPORTED_MODULE_2_geo_loc_utils__["degreeToCardinal"](item.nearestStormBearing);

    item.dateTime = __WEBPACK_IMPORTED_MODULE_1_moment___default.a.unix(item.time);
    !item.sunriseTime ? null : item.sunriseDateTime = __WEBPACK_IMPORTED_MODULE_1_moment___default.a.unix(item.sunriseTime);
    !item.sunsetTime ? null : item.sunsetDateTime = __WEBPACK_IMPORTED_MODULE_1_moment___default.a.unix(item.sunsetTime);
    !item.temperatureMinTime ? null : item.temperatureMinDateTime = __WEBPACK_IMPORTED_MODULE_1_moment___default.a.unix(item.temperatureMinTime);
    !item.temperatureMaxTime ? null : item.temperatureMaxDateTime = __WEBPACK_IMPORTED_MODULE_1_moment___default.a.unix(item.temperatureMaxTime);
    !item.apparentTemperatureMinTime ? null : item.apparentTemperatureMinDateTime = __WEBPACK_IMPORTED_MODULE_1_moment___default.a.unix(item.apparentTemperatureMinTime);
    !item.apparentTemperatureMaxTime ? null : item.apparentTemperatureMaxDateTime = __WEBPACK_IMPORTED_MODULE_1_moment___default.a.unix(item.apparentTemperatureMaxTime);
...
DarkSkyApi.loadPosition = () => __WEBPACK_IMPORTED_MODULE_2_geo_loc_utils__["getNavigatorCoords"]();

/* harmony default export */ __webpack_exports__["default"] = (DarkSkyApi);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_query_string__ = __webpack_require__(122);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_fetch_jsonp__ = __webpack_require__(125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_whatwg_fetch__ = __webpack_require__(126);
...
class DarkSkySkeleton {
  ...
  generateReqUrl() {
    ...
    !this.isEmpty(this.query) ? this.url += `?${__WEBPACK_IMPORTED_MODULE_0_query_string___default.a.stringify(this.query)}` : this.url;
  }
  ...
  get() {
    ...
    const query = this.proxyUrl ? __WEBPACK_IMPORTED_MODULE_2_whatwg_fetch___default.a(this.url) : __WEBPACK_IMPORTED_MODULE_1_fetch_jsonp___default.a(this.url);
...
/* harmony default export */ __webpack_exports__["default"] = (DarkSkySkeleton);
 ...
 * @namespace Chart
 */
var Chart = __webpack_require__(132)();
...
var conversions = __webpack_require__(135);
...
/* MIT license */
var colorNames = __webpack_require__(137);
